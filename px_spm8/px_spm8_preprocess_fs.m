function px_spm8_preprocess_fs (Output,PathFun,Para,PathT1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% px_spm8_preprocess_fs (Output,PathFun,Para,PathT1)
...
% For the coregister: Using ALL function images coregister to t1 structure.
%      I prefer px_spm8_preprocess_sf, because that one is faster.
% Output = 'Path output';
...
% BB = {[-90 -126 -72;90 90 108];[-78 -112 -50;78 76 85]};
% VS = [2 2 2]%[3 3 3]
%
...
matlabbatch{6}.spm.spatial.coreg.estimate.ref = DataT1;
matlabbatch{6}.spm.spatial.coreg.estimate.source(1) = cfg_dep;
matlabbatch{6}.spm.spatial.coreg.estimate.source(1).tname = 'Source Image';
matlabbatch{6}.spm.spatial.coreg.estimate.source(1).tgt_spec{1}(1).name = 'filter';
matlabbatch{6}.spm.spatial.coreg.estimate.source(1).tgt_spec{1}(1).value = 'image';
matlabbatch{6}.spm.spatial.coreg.estimate.source(1).tgt_spec{1}(2).name = 'strtype';
matlabbatch{6}.spm.spatial.coreg.estimate.source(1).tgt_spec{1}(2).value = 'e';
matlabbatch{6}.spm.spatial.coreg.estimate.source(1).sname = 'Realign: Estimate & Reslice: Mean Image';
matlabbatch{6}.spm.spatial.coreg.estimate.source(1).src_exbranch = substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{6}.spm.spatial.coreg.estimate.source(1).src_output = substruct('.','rmean');
for run = 1:NRun
    matlabbatch{6}.spm.spatial.coreg.estimate.other(run) = cfg_dep;
    matlabbatch{6}.spm.spatial.coreg.estimate.other(run).tname = 'Other Images';
    matlabbatch{6}.spm.spatial.coreg.estimate.other(run).tgt_spec{1}(1).name = 'filter';
    matlabbatch{6}.spm.spatial.coreg.estimate.other(run).tgt_spec{1}(1).value = 'image';
    matlabbatch{6}.spm.spatial.coreg.estimate.other(run).tgt_spec{1}(2).name = 'strtype';
    matlabbatch{6}.spm.spatial.coreg.estimate.other(run).tgt_spec{1}(2).value = 'e';
    matlabbatch{6}.spm.spatial.coreg.estimate.other(run).sname = ['Realign: Estimate & Reslice: Resliced Images (Sess ',num2str(run),')'];
    matlabbatch{6}.spm.spatial.coreg.estimate.other(run).src_exbranch = substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
    matlabbatch{6}.spm.spatial.coreg.estimate.other(run).src_output = substruct('.','sess', '()',{run}, '.','rfiles');
end
...
matlabbatch{7}.spm.spatial.preproc.data = DataT1;
...
matlabbatch{8}.spm.spatial.normalise.write.subj.resample(1).sname = 'Coregister: Estimate: Coregistered Images';
matlabbatch{8}.spm.spatial.normalise.write.subj.resample(1).src_exbranch = substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.spm.spatial.normalise.write.subj.resample(1).src_output = substruct('.','cfiles');
