function [para] = px_spm8_preprocess_coregister_estwrite(fdp,para)
...
% batch
matlabbatch{1}.spm.spatial.coreg.estwrite.ref = fdp.ref;
matlabbatch{1}.spm.spatial.coreg.estwrite.source = fdp.source;
matlabbatch{1}.spm.spatial.coreg.estwrite.other = fdp.other;
...
save (fullfile(para.op,'prep_coregister_estwrite'), 'matlabbatch');
% run
spm_jobman('initcfg');
spm('defaults', 'FMRI');
