function px_help
%% Server NIC 
% rdesktop -f 192.168.10.29
%
% scp -r Source user@Target:deskt, see below for an example:
% scp -r /media/DATA/resting_state/ cnp@192.168.10.29:/data/local_dir2/cnp/Pengfei
%
% rsync -av -e ssh source user@target:dest
% rsync -r (Recursively copy entire directories.)
%
% use sshfs to 'mount' it as if it were a local drive: 
