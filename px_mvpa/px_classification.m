function [Accuracy Sensitivity Specificity W_vector] = px_classification(Subjects_Ind, Subjects_Data, Subjects_Label, Pre_Method)
...
for i = Subjects_Ind
    ...
    [predicted_labels(i), a_tmp, ~] = svmpredict(test_label, test_data, model(i));
    Accuracy = a_tmp(1)/100;
