...
% P = px_expand_path('c:\my_experiment\[subject]\[run_pattern]\[file_pattern]');
...
% P = exp_wc(in);% Revised By PX, 1/9/2014
P = exp_wc(in)';
cd(old_path);
return;
